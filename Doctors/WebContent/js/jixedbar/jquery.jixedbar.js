		...
		jixedbar: new function(options) {
			...
			this.construct = function() {
				...
				return this.each(function() {
					...
					$("#jx-hid-con-id").html('<li alt="Ocultar barra"><a id="jx-hid-btn-id" class="' + hideIndicator + '"></a></li>');
					...
					$("#jx-uhid-itm-id").html('<li alt="Exibir Barra"><a id="jx-uhid-btn-id" class="' + unhideIndicator + '"></a></li>');
